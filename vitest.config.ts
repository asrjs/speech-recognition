...
export default defineConfig({
  resolve: {
    alias: [
      ...
      { find: /^asr\.js\/models\/whisper-seq2seq$/, replacement: resolve(__dirname, 'src/models/whisper-seq2seq/index.ts') },
      ...
      { find: /^@asrjs\/speech-recognition\/models\/whisper-seq2seq$/, replacement: resolve(__dirname, 'src/models/whisper-seq2seq/index.ts') },
