...
const DEFAULT_CONFIG: GigaAmRnntModelConfig = {
  ecosystem: 'gigaam', architecture: 'gigaam-rnnt', processorArchitecture: 'gigaam-fbank', encoderArchitecture: 'gigaam-conformer', decoderArchitecture: 'rnnt', sampleRate: 16000, rawStride: 4, nMels: 64, featureHopSeconds: 0.01, vocabularySize: 35, languages: ['ru'], tokenizer: { kind: 'sentencepiece', blankTokenId: 34 }, nFft: 320, winLength: 320, hopLength: 160, featureLayout: 'mel-major', predictionHiddenSize: 320, maxTokensPerFrame: 3,
};
