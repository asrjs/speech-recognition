...
export const WAV2VEC2_PRESET_MANIFESTS: readonly Wav2Vec2PresetManifest[] = [
  ...
  {
    preset: 'wav2vec2',
    modelId: 'facebook/wav2vec2-base-960h-fp16',
    aliases: ['wav2vec2-fp16', 'wav2vec2-base-960h-fp16', 'base-960h-fp16'],
    description: 'Facebook Wav2Vec2 Base 960h fp16 — same WER as fp32 (4.5%), 2x smaller (182 MB).',
    classification: {
      ecosystem: 'meta',
      processor: 'wav2vec2-conv',
      encoder: 'wav2vec2-conformer',
    ...
    config: {
      ...
      ctcBlankId: 0,
      languages: ['en'],
      tokenizer: { kind: 'char', blankTokenId: 0 },
      doStableLayerNorm: false,
      layerNormEps: 1e-5,
      featExtractActivation: 'gelu',
      convBias: false,
    ...
    source: {
      kind: 'huggingface',
      repoId: 'ysdede/wav2vec2-base-960h-onnx',
      modelFilename: 'wav2vec2-base-960h.fp16.onnx',
      modelDataFilename: 'wav2vec2-base-960h.fp16.onnx.data',
      tokenizerFilename: 'vocab.json',
    },
  },
  {
    preset: 'wav2vec2',
    modelId: 'facebook/wav2vec2-base-960h-q8',
    aliases: ['wav2vec2-q8', 'wav2vec2-base-960h-q8', 'base-960h-q8'],
    description: 'Facebook Wav2Vec2 Base 960h q8 — smallest (91 MB), but slower + WER 9.1% vs 4.5%. Use fp16 for best trade-off.',
    classification: {
      ecosystem: 'meta',
      processor: 'wav2vec2-conv',
      encoder: 'wav2vec2-conformer',
    ...
    source: {
      kind: 'huggingface',
      repoId: 'ysdede/wav2vec2-base-960h-onnx',
      modelFilename: 'wav2vec2-base-960h.q8.onnx',
      tokenizerFilename: 'vocab.json',
    },
  },
  {
  ...
  {
    preset: 'wav2vec2',
    modelId: 'm3hrdadfi/wav2vec2-large-xlsr-turkish-q8',
    aliases: ['wav2vec2-turkish-q8', 'xlsr-turkish-q8'],
    description: 'Wav2Vec2 Large XLSR-53 Turkish — int8 dynamic quantized. 303 MB single file, no external data.',
    classification: {
      ecosystem: 'meta',
      processor: 'wav2vec2-conv',
      encoder: 'wav2vec2-conformer',
    ...
    source: {
      kind: 'huggingface',
      repoId: 'ysdede/wav2vec2-large-xlsr-turkish-onnx',
      modelFilename: 'wav2vec2-large-xlsr-turkish.q8.onnx',
      tokenizerFilename: 'vocab.json',
    },
  },
  {
    preset: 'wav2vec2',
    modelId: 'm3hrdadfi/wav2vec2-large-xlsr-turkish-fp16',
    aliases: ['wav2vec2-turkish-fp16', 'xlsr-turkish-fp16'],
    description: 'Wav2Vec2 Large XLSR-53 Turkish — fp16. Best accuracy/speed trade-off: same WER as fp32, 32% faster.',
    classification: {
      ecosystem: 'meta',
      processor: 'wav2vec2-conv',
      encoder: 'wav2vec2-conformer',
    ...
    source: {
      kind: 'huggingface',
      repoId: 'ysdede/wav2vec2-large-xlsr-turkish-onnx',
      modelFilename: 'wav2vec2-large-xlsr-turkish.fp16.onnx',
      modelDataFilename: 'wav2vec2-large-xlsr-turkish.fp16.onnx.data',
      tokenizerFilename: 'vocab.json',
    },
  },
];
