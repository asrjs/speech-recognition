...
Master reference for designing `@asrjs/speech-recognition` from scratch. Maps all documented model families to **frontend**, **encoder**, **decoder topology**, and **decoding strategy**.
...
## @asrjs/speech-recognition Suggested Module Layout
