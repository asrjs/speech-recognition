"""
Convert exported Parakeet realtime ONNX artifacts to FP16 while keeping IO dtypes stable.
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Convert Parakeet realtime ONNX exports to FP16.")
