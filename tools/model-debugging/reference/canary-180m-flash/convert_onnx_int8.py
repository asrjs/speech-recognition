"""
Create INT8 dynamically quantized ONNX variants for Canary encoder/decoder exports.
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Convert Canary ONNX exports to INT8.")
    parser.add_argument("--model-dir", type=Path, required=True)
    parser.add_argument(
        "--artifacts",
        nargs="*",
        default=["encoder-model.onnx", "decoder-model.onnx"],
